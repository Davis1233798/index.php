	...
	<form method="POST" action="save.php?fn=add" enctype="multipart/form-data">
		<div class="card-block">
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					<input type="text" id="txt_title" name="txt_title" class="form-control" placeholder="請輸入中文黑字大標題" maxlength="100" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_detail">中文橘字大標題(ex.xx院長)</label>
				<div class="col-md-4">
					<input type="text" id="txt_detail" name="txt_detail" class="form-control" placeholder="請輸入中文橘字大標題" maxlength="100" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_en_title">英文黑字大標題</label>
				<div class="col-md-4">
					<input type="text" id="txt_en_title" name="txt_en_title" class="form-control" placeholder="請輸入英文黑字大標題" maxlength="100" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_en_detail">英文橘字大標題(ex.xx院長)</label>
				<div class="col-md-4">
					<input type="text" id="txt_en_detail" name="txt_en_detail" class="form-control" placeholder="請輸入英文橘字大標題" maxlength="100" />
				</div>
			</div>
			<div class="form-group row">
