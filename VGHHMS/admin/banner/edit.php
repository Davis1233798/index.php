	...
	<form method="POST" action="save.php?fn=edit" enctype="multipart/form-data">
		...
		<div class="card-block">
			...
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_acc">選擇檔案</label>
				<div class="col-md-6">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<img src="<? echo $_env["site_url"]."images/".$_pageenv["filename_tnfile"].".png"; ?>" style="background-image:url('<? echo $_env["site_upload_url"]."banner/".$data["filename"];?>');background-repeat:no-repeat;background-size:contain;background-position : 50% 50%" />
				</div>
			</div>
			<div class="form-group row">
