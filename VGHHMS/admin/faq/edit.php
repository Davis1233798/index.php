...
<div class="card">
	<div class="card-header">
		<a href="index.php">常見問題管理</a> - 修改內容
	</div>
	<form method="POST" action="save.php?fn=edit" enctype="multipart/form-data">
		...
		<div class="card-block">
			...
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_category_id">問題類型</label>
				<div class="col-md-4">
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					<textarea id="txt_question" name="txt_question" rows="9" class="form-control" placeholder="請輸入問題內容"><? echo $data["question"]; ?></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_answer"><i style="color: red;">* </i>問題解答</label>
				<div class="col-md-4">
					<textarea id="txt_answer" name="txt_answer" rows="9" class="form-control" placeholder="請輸入問題解答"><? echo $data["answer"]; ?></textarea>
				</div>
			</div>
			<div class="form-group row">
