...
<div class="card">
	<div class="card-header">
		<a href="index.php"><? echo $_pageenv['fn_name']; ?></a> - <? echo $_pageenv['fn_name_add']; ?>
	</div>
	<form method="POST" action="save.php?fn=add">
		<div class="card-block">
		
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_acc"><i style="color: red;">* </i>帳號</label>
				<div class="col-md-6">
					<input type="text" id="txt_acc" name="txt_acc" class="form-control" placeholder="請輸入帳號" maxlength="20" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_psd"><i style="color: red;">* </i>密碼</label>
				<div class="col-md-6">
					<input type="password" id="txt_psd" name="txt_psd" class="form-control" placeholder="請輸入密碼" maxlength="12" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_psd2"></label>
				<div class="col-md-6">
					<input type="password" id="txt_psd2" name="txt_psd2" class="form-control" placeholder="請再次輸入密碼" maxlength="12" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-md-2 form-control-label" for="txt_name">使用者姓名</label>
				<div class="col-md-6">
					<input type="text" id="txt_name" name="txt_name" class="form-control" placeholder="請輸入使用者姓名" maxlength="20" />
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-md-6">
					<label class="radio-inline" for="rd_inuse_t">
						<input type="radio" id="rd_inuse_t" name="rd_inuse" value="1" checked /> 啟用
					</label>
					<label class="radio-inline" for="rd_inuse_f">
						<input type="radio" id="rd_inuse_f" name="rd_inuse" value="0" /> 停用
					</label>
				</div>
			</div>
			<div class="form-group row">
						...
						<?
							...
							while($i<$_max){
								...
								if($row['c_code']==''){
									...
									echo '<input type="checkbox" name="chk_auth[]" value="', $row['fn_id'], '" /> ', $row['fn_name'];
									echo '</label>';
								} else {
									echo '<label class="radio-inline"><i class="fa fa-bullseye fa-lg"></i> ', $row['fn_name'], '</label>';
									
									echo '<label class="radio-inline">';
									echo '<input type="checkbox" name="chk_auth[]" value="', $row['c_id'], '" /> ', $row['c_name'];
									echo '</label>';
