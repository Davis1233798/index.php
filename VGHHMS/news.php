...
<div class="wrapper">
 <div class="container">
  ...
  <div class="page">
   <ul>
    <li><a href="<? echo ($page<=1)?'javascript:void(0)':'news.php?p='.($page-1) ?>">上一頁</a></li>
    <li>第
      <select id="sel_page">
    ...
    <li><a href="<? echo ($page>=$data['pager']['total_pages'])?'javascript:void(0)':'news.php?p='.($page+1) ?>">下一頁</a></li>
   </ul>
  </div> 
...
<script type="text/javascript">
  $('#sel_page').on('change', function(){
      window.location.href='news.php?p='+$(this).val();
  })
</script>
</body>
</html>
